...
contract DeploySystem is Script {
    ...
    function run() external {
        ...
        console.log("YieldVault implementation deployed at:", address(vaultImpl));

        bytes memory vaultInitData = abi.encodeCall(
            YieldVault.initialize, (IERC20(address(govToken)), address(timelock), chainlinkFeed, 3600, 20_000_000e18)
        );
