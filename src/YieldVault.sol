...
import { ReentrancyGuard as ReentrancyGuardUpgradeable } from "@openzeppelin/contracts/utils/ReentrancyGuard.sol";
    ...
    UUPSUpgradeable
{
    ...
    function initialize(IERC20 asset_, address admin, address _priceFeed, uint256 _maxStaleness, uint256 _minPrice)
        external
        initializer
    {
